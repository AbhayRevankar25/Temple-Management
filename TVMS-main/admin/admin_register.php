...
<body class="overflow-x-hidden antialiased" style="background: linear-gradient(to right, #c8bcd4, #fcfdff);">
    <?php
    ...
    ?>
    <!-- Registration Form -->
    <div class="p-4 sm:ml-64" style="margin-top: 30px;">
        <div class="p-4 border-2 border-gray-900 border-solid rounded-lg dark:border-gray-700 mt-14" >
